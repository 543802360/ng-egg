    ...
    "layers": [
        {
            ...
            "type": "background",
            "paint": {
                "background-color": "rgba(0,52,82,255)"
            }
        },
        {
        ...
        },
        {
            ...
            "paint": {
                "fill-extrusion-color": "rgba(123,138,154,255)",
