const dark = {
  ...
  "sources": {
    "world": {
      "type": "vector",
      "scheme": "tms",
      "tiles": ["http://47.105.192.51:10010/vtiles/world/{z}/{x}/{y}.pbf"]
    },
    "dtbj": {
      "type": "vector",
      "scheme": "tms",
      "tiles": ["http://47.105.192.51:10010/vtiles/dtbj/{z}/{x}/{y}.pbf"]
    },
    "xzbz": {
      "type": "vector",
      "scheme": "tms",
      "tiles": ["http://47.105.192.51:10010/vtiles/xzbz/{z}/{x}/{y}.pbf"]
    },
    "poi": {
      "type": "vector",
      "scheme": "tms",
      "tiles": ["http://47.105.192.51:10010/vtiles/poi/{z}/{x}/{y}.pbf"]
    },
    "road": {
      "type": "vector",
      "scheme": "tms",
      "tiles": ["http://47.105.192.51:10010/vtiles/road/{z}/{x}/{y}.pbf"]
    },
    "road2": {
      "type": "vector",
      "scheme": "tms",
      "tiles": ["http://47.105.192.51:10010/vtiles/road2/{z}/{x}/{y}.pbf"]
    },
    "jzw": {
      "type": "vector",
      "scheme": "tms",
      "tiles": ["http://47.105.192.51:10010/vtiles/jzw/{z}/{x}/{y}.pbf"]
    }
  },
  "layers": [{
    "id": "background",
