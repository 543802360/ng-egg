...
@Component({
  selector: 'dqy-condition',
  templateUrl: './dqy-condition.component.html',
  styleUrls: ['./dqy-condition.component.less']
})
export class MobileDqyConditionComponent implements OnInit {
  // 是否打开drawer
  state = {
    open: true
  };
  ...
  //税收名次选择
  zdnsrData = ['亿元以上', '1000万以上', '500万以上', '200万以上', '100万以上', '50万以上', '10万以上'];
  selectedNum = '1000万以上';
  selectedNumArray = [];
  ...
  onOk() {
    ...
    if (this.countySelected || this.citySelected || this.centerSelected) {
      ...
      const value = this.selectedNum == "亿元以上" ? 10000
        : this.selectedNum == "1000万以上" ? 1000
          : this.selectedNum == "500万以上" ? 500
            : this.selectedNum == "200万以上" ? 200
              : this.selectedNum == "100万以上" ? 100
                : this.selectedNum == "50万以上" ? 50
                  : 10;
