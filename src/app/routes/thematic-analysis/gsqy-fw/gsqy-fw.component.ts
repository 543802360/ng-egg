...
@Component({
  ...
  templateUrl: './gsqy-fw.component.html',
  styleUrls: ['./gsqy-fw.component.less']
})
export class GsqyfwEnterpriseGroupOrderComponent implements OnInit, AfterViewInit, ReuseComponentInstance {
  ...
  //jtfbUrl = `jtqy/jtfb`;
  // 按税务机关排序URL
  jgtjUrl = 'http://140.68.16.96:10080/ytswht/api/gsqyfwy/jgtj?_allow_anonymous=true';
  jgtjData: itemInfo[];
  jtpmUrl = 'http://140.68.16.96:10080/ytswht/api/gsqyfwy/gsqyfwyzb?_allow_anonymous=true';
  jtpmData: itemInfo[];
          ...
          "paint": {
            'fill-color':
            {
              ...
              stops: [
                [0, COLORS.primary[0]],
                [50, COLORS.primary[2]],
                [100, COLORS.primary[4]],
                [200, COLORS.primary[5]],
                [300, COLORS.primary[6]],
                [400, COLORS.primary[7]],
                [500, COLORS.primary[8]]
              ]
            },
            'fill-opacity': 0.9,
