...
@Component({
  ...
  templateUrl: './gsqy-gy.component.html',
  styleUrls: ['./gsqy-gy.component.less']
})
export class GsqygyEnterpriseGroupOrderComponent implements OnInit, AfterViewInit, ReuseComponentInstance {
  ...
  //jtfbUrl = `jtqy/jtfb`;
  // 按税务机关排序URL
  jgtjUrl = 'http://140.68.16.96:10080/ytswht/api/gsqygy/jgtj?_allow_anonymous=true';
  jgtjData: itemInfo[];
  jtpmUrl = 'http://140.68.16.96:10080/ytswht/api/gsqygy/gsqygyzb?_allow_anonymous=true';
  jtpmData: itemInfo[];
