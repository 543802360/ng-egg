...
@Component({
  ...
  templateUrl: './gxjs.component.html',
  styleUrls: ['./gxjs.component.less']
})
export class GxjsEnterpriseGroupOrderComponent implements OnInit, AfterViewInit, ReuseComponentInstance {
  ...
  //jtfbUrl = `jtqy/jtfb`;
  // 按税务机关排序URL
  jgtjUrl = 'http://140.68.16.96:10080/ytswht/api/gxjsqy/jgtj?_allow_anonymous=true';
  jgtjData: itemInfo[];
  jtpmUrl = 'http://140.68.16.96:10080/ytswht/api/gxjsqy/gxjsqyzb?_allow_anonymous=true';
  jtpmData: itemInfo[];
          ...
          "paint": {
            'fill-color':
            {
              ...
              stops: [
                ...
                [400, COLORS.primary[4]],
                [500, COLORS.primary[5]],
                [600, COLORS.primary[6]],
                [800, COLORS.primary[7]],
                [1000, COLORS.primary[8]]
              ]
            },
            'fill-opacity': 0.9,
