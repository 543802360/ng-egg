...
@Component({
  ...
  templateUrl: './jzqy.component.html',
  styleUrls: ['./jzqy.component.less']
})
export class JzqyEnterpriseGroupOrderComponent implements OnInit, AfterViewInit, ReuseComponentInstance {
  ...
  //jtfbUrl = `jtqy/jtfb`;
  // 按税务机关排序URL
  jgtjUrl = 'http://140.68.16.96:10080/ytswht/api/jzqy/jgtj?_allow_anonymous=true';
  jgtjData: itemInfo[];
  jtpmUrl = 'http://140.68.16.96:10080/ytswht/api/jzqy/jzqyzb?_allow_anonymous=true';
  jtpmData: itemInfo[];
          ...
          "paint": {
            'fill-color':
            {
              ...
              stops: [
                [0, COLORS.primary[0]],
                [50, COLORS.primary[2]],
                [150, COLORS.primary[4]],
                [250, COLORS.primary[5]],
                [350, COLORS.primary[6]],
                [500, COLORS.primary[7]],
                [650, COLORS.primary[8]]
              ]
            },
            'fill-opacity': 0.9,
