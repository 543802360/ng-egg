...
@Component({
  ...
  templateUrl: './kjxzx.component.html',
  styleUrls: ['./kjxzx.component.less']
})
export class KjxzxEnterpriseGroupOrderComponent implements OnInit, AfterViewInit, ReuseComponentInstance {
  ...
  //jtfbUrl = `jtqy/jtfb`;
  // 按税务机关排序URL
  jgtjUrl = 'http://140.68.16.96:10080/ytswht/api/kjxzxqy/jgtj?_allow_anonymous=true';
  jgtjData: itemInfo[];
  jtpmUrl = 'http://140.68.16.96:10080/ytswht/api/kjxzxqy/kjxzxqyzb?_allow_anonymous=true';
  jtpmData: itemInfo[];
        ...
        (this.map as any).addLayer({
          ...
          "paint": {
            'fill-color':
            {
              ...
              stops: [
                [0, COLORS.primary[0]],
                [100, COLORS.primary[1]],
                [300, COLORS.primary[2]],
                [500, COLORS.primary[3]],
                [800, COLORS.primary[4]],
                [1000, COLORS.primary[6]],
                [1500, COLORS.primary[8]]
              ]
            },
            'fill-opacity': 0.9,
