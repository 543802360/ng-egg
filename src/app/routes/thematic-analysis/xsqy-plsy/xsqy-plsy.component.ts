...
@Component({
  ...
  templateUrl: './xsqy-plsy.component.html',
  styleUrls: ['./xsqy-plsy.component.less']
})
export class XsqyplsyEnterpriseGroupOrderComponent implements OnInit, AfterViewInit, ReuseComponentInstance {
  ...
  //jtfbUrl = `jtqy/jtfb`;
  // 按税务机关排序URL
  jgtjUrl = 'http://140.68.16.96:10080/ytswht/api/xsqyplsy/jgtj?_allow_anonymous=true';
  jgtjData: itemInfo[];
  jtpmUrl = 'http://140.68.16.96:10080/ytswht/api/xsqyplsy/xsqyplsyzb?_allow_anonymous=true';
  jtpmData: itemInfo[];
        ...
        (this.map as any).addLayer({
          ...
          "paint": {
            'fill-color':
            {
              ...
              stops: [
                [0, COLORS.primary[0]],
                [300, COLORS.primary[1]],
                [500, COLORS.primary[2]],
                [800, COLORS.primary[3]],
                [1000, COLORS.primary[4]],
                [1200, COLORS.primary[5]],
                [1500, COLORS.primary[6]],
                [2000, COLORS.primary[7]],
                [2500, COLORS.primary[8]]
              ]
            },
            'fill-opacity': 0.9,
