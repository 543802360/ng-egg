...
@Component({
  ...
  templateUrl: './jry-summary.component.html',
  styleUrls: ['./jry-summary.component.less']
})
export class JrySummaryComponent implements OnInit, AfterViewInit {
  ...
  download() {
    ...
    this.xlsx.export({
      ...
      filename: `金融业税收统计-${new Date().toLocaleString()}.xlsx`
    }).then(e => {
      this.loadSrv.close();
    });
  }
