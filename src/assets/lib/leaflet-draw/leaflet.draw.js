...
(function(window, document, undefined) {
  ...
  L.drawLocal = {
    draw: {
      ...
      handlers: {
        ...
        polyline: {
          error: "<strong>错误:</strong> 图形不允许交叉!",
          tooltip: {
            start: "点击地图开始绘制线.",
            cont: "点击地图继续绘制线.",
            end: "点击最后一个点完成绘制."
  ...
  L.Draw.Polyline = L.Draw.Feature.extend({
    ...
    _updateGuideColor: function(color) {
      if (this._guidesContainer) {
        for (
          var i = 0, l = this._guidesContainer.childNodes.length;
          i < l;
          i++
        ) {
  ...
  L.Draw.Polygon = L.Draw.Polyline.extend({
    ...
    _updateFinishHandler: function() {
      ...
      if (markerCount > 2) {
        ...
        if (markerCount > 3) {
          this._markers[markerCount - 2].off(
            "dblclick",
            this._finishShape,
            this
          );
    ...
    _cleanUpShape: function() {
      ...
      if (markerCount > 0) {
        ...
        if (markerCount > 2) {
          this._markers[markerCount - 1].off(
            "dblclick",
            this._finishShape,
            this
          );
    ...
    _initHandlers: function() {
      ...
      for (var i = 0; i < this.latlngs.length; i++) {
        this._verticesHandlers.push(
          new L.Edit.PolyVerticesEdit(this._poly, this.latlngs[i], this.options)
        );
      }
    },
  ...
  L.Polyline.include({
    ...
    newLatLngIntersects: function(latlng, skipFirst) {
      ...
      return this.newPointIntersects(
    ...
    newPointIntersects: function(newPoint, skipFirst) {
      ...
      return this._lineSegmentsIntersectsRange(
        lastPoint,
        newPoint,
        maxIndex,
        skipFirst ? 1 : 0
